...
{
    public class AIHDSettingsView : VisualElement
    {
        AIHDMasterNode m_Node;
        ...
        public AIHDSettingsView( AIHDMasterNode node )
        {
            m_Node = node;
            ...
            if (m_Node.surfaceType == SurfaceType.Transparent)
            {
                ...
                if (!m_Node.HasRefraction())
                {
                    ...
                    {
                        row.Add(new EnumField( AIHDMasterNode.AlphaModeLit.Additive), (field) =>
                        {
            ...
            {
                row.Add(new EnumField( AIHDMasterNode.MaterialType.Standard), (field) =>
                {
            ...
            ++indentLevel;
            if (m_Node.materialType == AIHDMasterNode.MaterialType.SubsurfaceScattering)
            {
            ...
            if (m_Node.materialType == AIHDMasterNode.MaterialType.SpecularColor)
            {
        ...
        void ChangeMaterialType(ChangeEvent<Enum> evt)
        {
            ...
            m_Node.materialType = (AIHDMasterNode.MaterialType)evt.newValue;
        }
        ...
        void ChangeBlendMode(ChangeEvent<Enum> evt)
        {
            ...
            AlphaMode alphaMode = GetAlphaMode((AIHDMasterNode.AlphaModeLit)evt.newValue);
        ...
        public AlphaMode GetAlphaMode( AIHDMasterNode.AlphaModeLit alphaModeLit)
        {
            switch (alphaModeLit)
            {
                case AIHDMasterNode.AlphaModeLit.Alpha:
                    return AlphaMode.Alpha;
                case AIHDMasterNode.AlphaModeLit.Premultiply:
                    return AlphaMode.Premultiply;
                case AIHDMasterNode.AlphaModeLit.Additive:
        ...
        public AIHDMasterNode.AlphaModeLit GetAlphaModeLit(AlphaMode alphaMode)
        {
            switch (alphaMode)
            {
                case AlphaMode.Alpha:
                    return AIHDMasterNode.AlphaModeLit.Alpha;
                case AlphaMode.Premultiply:
                    return AIHDMasterNode.AlphaModeLit.Premultiply;
                case AlphaMode.Additive:
                    return AIHDMasterNode.AlphaModeLit.Additive;
                default:
                    {
